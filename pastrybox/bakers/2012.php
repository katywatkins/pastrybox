...
$bakers = array(
  ...
  array(
    ...
    "portrait_alt" => $config->portrait_of . "Ben Ward",
    "path_to_bio"  => 'bakers/data/' . $year . "/bio/ben-ward.php",
    "twitter"      => "BenWard",
  ),
  ...
  array(
    ...
    "portrait_alt" => $config->portrait_of . "Bruce Lawson",
    "path_to_bio"  => 'bakers/data/' . $year . "/bio/bruce-lawson.php",
    "twitter"      => "brucel",
  ),
  ...
  array(
    ...
    "portrait_alt" => $config->portrait_of . "Cennydd Bowles",
    "path_to_bio"  => 'bakers/data/' . $year . "/bio/cennydd-bowles.php",
    "twitter"      => "Cennydd",
  ),
  ...
  array(
    ...
    "portrait_alt" => $config->portrait_of . "Dan Eden",
    "path_to_bio"  => 'bakers/data/' . $year . "/bio/dan-eden.php",
    "twitter"      => "_dte",
  ),
  ...
  array(
    ...
    "portrait_alt" => $config->portrait_of . "Dan Mall",
    "path_to_bio"  => 'bakers/data/' . $year . "/bio/dan-mall.php",
    "twitter"      => "danielmall",
  ),
  ...
  array(
    ...
    "portrait_alt" => $config->portrait_of . "Denise Jacobs",
    "path_to_bio"  => 'bakers/data/' . $year . "/bio/denise-jacobs.php",
  ...
  array(
    ...
    "portrait_alt" => $config->portrait_of . "Elliot Jay Stocks",
    "path_to_bio"  => 'bakers/data/' . $year . "/bio/elliot-jay-stocks.php",
  ...
  array(
    ...
    "portrait_alt" => $config->portrait_of . "Emily Lewis",
    "path_to_bio"  => 'bakers/data/' . $year . "/bio/emily-lewis.php",
    "twitter"      => "emilylewis",
  ),
  ...
  array(
    ...
    "portrait_alt" => $config->portrait_of . "Ethan Marcotte",
    "path_to_bio"  => 'bakers/data/' . $year . "/bio/ethan-marcotte.php",
    "twitter"      => "beep",
  ),
  ...
  array(
    ...
    "portrait_alt" => $config->portrait_of . "Frances Berriman",
    "path_to_bio"  => 'bakers/data/' . $year . "/bio/frances-berriman.php",
    "twitter"      => "phae",
  ),
  ...
  array(
    ...
    "portrait_alt" => $config->portrait_of . "Harry Roberts",
    "path_to_bio"  => 'bakers/data/' . $year . "/bio/harry-roberts.php",
    "twitter"      => "csswizardry",
  ),
  ...
  array(
    ...
    "portrait_alt" => $config->portrait_of . "Inayaili de Leon",
    "path_to_bio"  => 'bakers/data/' . $year . "/bio/inayaili-de-leon.php",
    "twitter"      => "yaili",
  ),
  ...
  array(
    ...
    "portrait_alt" => $config->portrait_of . "Jenn Lukas",
    "path_to_bio"  => 'bakers/data/' . $year . "/bio/jenn-lukas.php",
    "twitter"      => "JennLukas",
  ),
  ...
  array(
    ...
    "portrait_alt" => $config->portrait_of . "John Allsopp",
    "path_to_bio"  => 'bakers/data/' . $year . "/bio/john-allsopp.php",
    "twitter"      => "johnallsopp",
  ),
  ...
  array(
    ...
    "portrait_alt" => $config->portrait_of . "Jon Tan",
    "path_to_bio"  => 'bakers/data/' . $year . "/bio/jon-tan.php",
  ...
  array(
    "name"         => "Keir Whitaker",
    "slug"    => 'keir-whitaker',
    "profile_url"  => $config->url . "baker/keir-whitaker/",
    "portrait_url" => $config->data_url . $year . "/portraits/keir-whitaker.png",
    "portrait_small_url" => $config->data_url . $year . "/portraits/keir-whitaker-small.png",
    "portrait_alt" => $config->portrait_of . "Keir Whitaker",
    "path_to_bio"  => 'bakers/data/' . $year . "/bio/keir-whitaker.php",
  ...
  array(
    ...
    "portrait_alt" => $config->portrait_of . "Krista Stevens",
    "path_to_bio"  => 'bakers/data/' . $year . "/bio/krista-stevens.php",
    "twitter"      => "kristastevens",
  ),
  ...
  array(
    ...
    "portrait_alt" => $config->portrait_of . "Lea Verou",
    "path_to_bio"  => 'bakers/data/' . $year . "/bio/lea-verou.php",
    "twitter"      => "LeaVerou",
  ),
  ...
  array(
    ...
    "portrait_alt" => $config->portrait_of . "Leisa Reichelt",
    "path_to_bio"  => 'bakers/data/' . $year . "/bio/leisa-reichelt.php",
    "twitter"      => "leisa",
  ),
  ...
  array(
    ...
    "portrait_alt" => $config->portrait_of . "Matthew Smith",
    "path_to_bio"  => 'bakers/data/' . $year . "/bio/matthew-smith.php",
    "twitter"      => "whale",
  ),
  ...
  array(
    ...
    "portrait_alt" => $config->portrait_of . "Molly Holzschlag",
    "path_to_bio"  => 'bakers/data/' . $year . "/bio/molly-holzschlag.php",
    "twitter"      => "mollydotcom",
  ),
  ...
  array(
    ...
    "portrait_alt" => $config->portrait_of . "Paul O'Brien",
    "path_to_bio"  => 'bakers/data/' . $year . "/bio/paul-obrien.php",
    "twitter"      => "",
  ),
  ...
  array(
    ...
    "portrait_alt" => $config->portrait_of . "Rachel Andrew",
    "path_to_bio"  => 'bakers/data/' . $year . "/bio/rachel-andrew.php",
  ...
  array(
    ...
    "portrait_alt" => $config->portrait_of . "Richard Clark",
    "path_to_bio"  => 'bakers/data/' . $year . "/bio/richard-clark.php",
    "twitter"      => "Rich_Clark",
  ),
  ...
  array(
    ...
    "path_to_bio"  => 'bakers/data/' . $year . "/bio/rob-weychert.php",
    "twitter"      => "robweychert",
  ),
  ...
  array(
    ...
    "portrait_alt" => $config->portrait_of . "Stephen Anderson",
    "path_to_bio"  => 'bakers/data/' . $year . "/bio/stephen-anderson.php",
  ...
  array(
    ...
    "portrait_alt" => $config->portrait_of . "Stuart Langridge",
    "path_to_bio"  => 'bakers/data/' . $year . "/bio/stuart-langridge.php",
    "twitter"      => "sil",
  ),
  ...
  array(
    ...
    "portrait_alt" => $config->portrait_of . "Veerle Pieters",
    "path_to_bio"  => 'bakers/data/' . $year . "/bio/veerle-pieters.php",
    "twitter"      => "vpieters",
  ),
